...
describe('workspace-project Tiquete', () => {
    ...
    it('No deberia haber registros', () =>{
        header.clickLinkGestionTiquete();

        expect(tiquete.getNoRegistrosBdText()).toEqual('No hay registros en la base de datos.');
    });
    ...
    it('Deberia crear tiquete', () =>{
        ...
        expect(swal.getContentTextPopUp()).toEqual('El tiquete ha sido creado con exito!');
        swal.clickBtnOkSi();
    });
    ...
    it('Deberia eliminar tiquete', () =>{
        ...
        swal.clickBtnOkSi();
        expect(swal.getTitleTextPopUp()).toEqual('El tiquete ha sido eliminado exitosamente!');
    });
});
